...
run: build
	docker run -d --name $(APP_NAME) \
		...
		-e FREE_RESTRICTIONS_FROM=$(FREE_RESTRICTIONS_FROM) \
		-e FREE_MAX_TEMPLATES=$(FREE_MAX_TEMPLATES) \
		-e FREE_MAX_WORKSPACES=$(FREE_MAX_WORKSPACES) \
		-e RAZORPAY_PLAN_STARTER_MONTHLY=$(RAZORPAY_PLAN_STARTER_MONTHLY) \
		-e RAZORPAY_PLAN_STARTER_YEARLY=$(RAZORPAY_PLAN_STARTER_YEARLY) \
		-e RAZORPAY_PLAN_PRO_MONTHLY=$(RAZORPAY_PLAN_PRO_MONTHLY) \
		-e RAZORPAY_PLAN_PRO_YEARLY=$(RAZORPAY_PLAN_PRO_YEARLY) \
		$(APP_NAME)
	@echo ""
